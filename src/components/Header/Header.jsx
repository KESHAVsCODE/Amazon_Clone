...
const Header = () => {
  ...
  return (
    <header name="header">
      <div
        name="header-top"
        className="flex items-center justify-between h-[60px] gap-0 lgl:gap-2 bg-amazon_blue text-white sticky top-0 left-0 right-0 px-3 py-[5px]  z-[199]"
      >
        {/* ======================= Left Section ======================= */}
        <section
          name="header-left"
        ...
        >
          ...
          <section name="orders" className="headerHover hidden lg:inline-block">
